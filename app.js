...
const io = new Server(server, {
  cors: {
    origin: ["http://localhost:8100", DATABASE_URL, "https://autocare-vvzo.onrender.com", "https://autocare-ionic-1a0z.onrender.com", "https://autocare-6ij1.onrender.com","https://feppv-vitalure.s3.eu-central-1.amazonaws.com", "https://pay.easypay.pt"],
...
app.use(
  cors({
    origin: ["http://localhost:8100", 'https://autocare-vvzo.onrender.com', "https://autocare-ionic-1a0z.onrender.com", "https://autocare-6ij1.onrender.com"],
    methods: ["GET", "PUT", "POST", "DELETE"],
    credentials: true,
  })
);
